...
def parse_args():                                                                                                           
     parser = argparse.ArgumentParser(description="Advent of Code 2023 Day 2 solution")                                      
     parser.add_argument('-i', '--input', default="aoc2023-day2-input.txt", help="Input file path")                          
